...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        display = {
            ...
            "piVersion": verified.get("piVersion", ""), "rollbackPlan": _rollback_plan(staged_root, data_root),
        }
        ...
        if decision == "reject":
            ...
            result = activate(staged_root, data_root)
            state_root = Path(result["dataRoot"]) / "state"
