...
- Luna/Sol role mapping and child depth/concurrency caps; investigation uses Luna high, workers use Luna max, and review tiers use Luna xhigh/Luna max/Sol xhigh.
