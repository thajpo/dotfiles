...
"""
    ...
    def test_core_patch_is_versioned_and_installed_transactionally(self):
        ...
        patch = (ROOT / "pi/patches/pi-coding-agent-0.83.0-pinned-editor.patch").read_text()
        ...
        self.assertIn("isKeyRelease(data)", patch)
        self.assertIn("matchesKey(data, key)", patch)
        self.assertIn('["ctrl+g", "\\x07"]', patch)
